...
func Run() {
	...
	r.HandleFunc("/cart/{id}/delete", router.DeleteTicketHandler).Methods(http.MethodDelete)
	r.HandleFunc("/cart/{id}/clear", router.ClearHandler).Methods(http.MethodDelete)
